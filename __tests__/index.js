...
//   buildFixture('commonjs', function (err, bundle) {
//     t.ifError(err)
//     const ast = require('acorn').parse(bundle)
//     const modules = unpack(ast)
//     t.ok(modules)
//     t.equal(modules.length, 4)
...
//     const entry = modules.filter(function (m) { return m.entry })[0]
...
//     t.ifError(err)
//     const modules = unpack(bundle)
//     const splitModules = unpack(assets['1.bundle.js'].source())
//     t.ok(modules)
//     t.ok(splitModules)
//     t.equal(modules.length, 1)
//     t.equal(splitModules.length, 1)
//     const entry = modules.filter(function (m) { return m.entry })[0]
//     const splitEntry = splitModules[0]
